...
// <ACEStransformID>InvODT.Academy.P3DCI_48nits_D65sim.a1.0.3</ACEStransformID>
// <ACESuserName>ACES 1.0 Inverse Output - P3-DCI (D65 sim.)</ACESuserName>
// Created by SHED 2016-10-03

// 
// Inverse Output Device Transform - P3-DCI (D65 Simulation)
//
...
)
{
  ...
  // Convert from display primary encoding
    ...
    // Apply CAT from assumed observer adapted white point to ACES white point
    // (map D65 to D60)
